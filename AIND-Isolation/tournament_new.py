...
from game_agent import heuristic_simple_weighted, heuristic_simple_weighted_inv
from game_agent import heuristics_offensive, heuristics_offensive_weighted, heuristics_offensive_weighted_inv 
from game_agent import heuristics_proximity_min, heuristics_proximity_min_weighted, heuristics_proximity_min_weighted_inv
from game_agent import heuristics_proximity_max, heuristics_proximity_max_weighted, heuristics_proximity_max_weighted_inv
from game_agent import heuristic_simple_deeper, heuristic_offensive_deeper
...
# list of student heuristics
HEURISTICS_STUDENT = [heuristic_simple_weighted, heuristic_simple_weighted_inv, heuristic_simple_deeper,
              heuristics_offensive, heuristics_offensive_weighted, heuristics_offensive_weighted_inv, heuristic_offensive_deeper,
              heuristics_proximity_min, heuristics_proximity_min_weighted, heuristics_proximity_min_weighted_inv,
              heuristics_proximity_max, heuristics_proximity_max_weighted, heuristics_proximity_max_weighted_inv] 
...
def main():
    ...
    print(DESCRIPTION)
    print("Student heuristics:")
    
    test_agents = [Agent(CustomPlayer(score_fn=improved_score, 
                                    **CUSTOM_ARGS), "ID_Improved")]
    for heuristic_tmp in HEURISTICS_STUDENT:
               test_agents.append(Agent(CustomPlayer(score_fn=heuristic_tmp, 
                                    **CUSTOM_ARGS), heuristic_tmp.__name__))
               print(heuristic_tmp.__name__)
